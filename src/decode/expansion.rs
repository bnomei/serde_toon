...
pub(crate) fn should_expand_key(key: &str, mode: PathExpansionMode) -> Option<Vec<&str>> {
    match mode {
...
pub(crate) fn expand_paths_in_object(
...
pub(crate) fn expand_paths_recursive(
    value: Value,
    mode: PathExpansionMode,
    strict: bool,
) -> ToonResult<Value> {
