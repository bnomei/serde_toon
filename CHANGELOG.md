...
## [Unreleased]
### 2026-02-04
- Minor: Added small scalar encode caches for non-tabular strings and numbers.
...
- Minor: Added reader vs string decode benchmark coverage.
- Minor: Buffered `from_reader` inputs to preserve arena decoding semantics.
